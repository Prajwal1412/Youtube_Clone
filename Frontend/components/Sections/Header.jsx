        ...
        {(isHomepage || isSearchpage) && (
          ...
          <ul className="sidelinks-links">
            ...
            <li className="sidelinks-link" onClick={() => setCategory(22)}>
              ...
              <p className="sidelinks-link-text">Shorts</p>
            </li>

            <li
              className="sidelinks-link"
              onClick={() => navigate(isAuthenticated ? "/Channel" : "/Auth")}
            >
              <i className="fa-brands fa-square-youtube sidelinks-link-icons"></i>
              <p className="sidelinks-link-text">Subscriptions</p>
            </li>
            ...
            >
              ...
              <p className="sidelinks-link-text">You</p>{" "}
            </li>
          </ul>
        )}
      </div>
