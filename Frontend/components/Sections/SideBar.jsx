      ...
      <div className="sidebar-container">
        ...
        <nav className="side_nav">
          <ul className="sidebar-links">
            <li
              className={`sidebar-link ${category === 0 ? "active-Link" : ""}`}
              onClick={() => {
                setCategory(0);
                onToggle();
              }}
            ...
            <li
              className={`sidebar-link ${category === 22 ? "active-Link" : ""}`}
              onClick={() => {
                setCategory(22);
                onToggle();
              }}
            ...
            <li className="sidebar-link">
              ...
              <p className="sidebar-link-text">Subscriptions</p>
            </li>
          </ul>
        </nav>
        <nav className="side_nav">
          ...
          <ul className="sidebar-links">
            <li
              className={`sidebar-link ${category === 20 ? "active-Link" : ""}`}
              onClick={() => {
                setCategory(20);
                onToggle();
              }}
            ...
            <li
              className={`sidebar-link ${category === 2 ? "active-Link" : ""}`}
              onClick={() => {
                setCategory(2);
                onToggle();
              }}
            ...
            <li
              className={`sidebar-link ${category === 17 ? "active-Link" : ""}`}
              onClick={() => {
                setCategory(17);
                onToggle();
              }}
            ...
            <li
              className={`sidebar-link ${category === 25 ? "active-Link" : ""}`}
              onClick={() => {
                setCategory(25);
                onToggle();
              }}
            ...
            <li
              className={`sidebar-link ${category === 24 ? "active-Link" : ""}`}
              onClick={() => {
                setCategory(24);
                onToggle();
              }}
            ...
            <li
              className={`sidebar-link ${category === 1 ? "active-Link" : ""}`}
              onClick={() => {
                setCategory(1);
                onToggle();
              }}
